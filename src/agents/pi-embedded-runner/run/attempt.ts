...
// Local branch customization: `/coding enhance` is a prompt-level hook that strips
// the flag from the user prompt and adds a stronger delivery-oriented system hint.
// Keep this helper when merging if this branch still wants the shortcut behavior.
